...
export const gearItems: GearItem[] = [
{
  ...
  specs: [
    ...
    { label: 'AUDIO', value: 'Dolby Atmos / Smart Amp', icon: <FaMusic />, tag: 'DUAL SPEAKERS' },
    { label: 'BATTERY', value: '90Wh 4-Cell Li-Ion', icon: <FaBatteryFull />, tag: 'FAST CHARGE' },
    { label: 'WEIGHT', value: '3.0 kg', icon: <FaWeightHanging />, tag: 'PORTABLE WS' },
  ],
  specLayout: 'flat',
  imagePosition: 'left',
...
},
  {
    ...
    gallery: [
      '/images/gear/rog-strix-g15-view-1.png',
      '/images/gear/rog-strix-g15-view-2.png',
      '/images/gear/rog-strix-g15-view-3.png',
    ],
    specs: [
      { label: 'CPU', value: 'Ryzen 7 4800H (8C/16T)', icon: <SiAmd />, tag: 'ZEN 2' },
      { label: 'GPU', value: 'RTX 3050 4GB GDDR6', icon: <BsNvidia />, tag: '60W TGP' },
      { label: 'RAM', value: '32GB DDR4-3200', icon: <FaMemory />, tag: '2x16GB' },
      { label: 'STORAGE', value: '1TB NVMe PCIe 3.0', icon: <FaHdd />, tag: 'M.2' },
      { label: 'DISPLAY', value: '15.6" FHD 144Hz', icon: <FaDesktop />, tag: 'IPS-LEVEL' },
      { label: 'COOLING', value: 'Dual-Fan / 4-Heatpipe', icon: <FaThermometerHalf />, tag: 'SELF-CLEAN' },
      { label: 'NETWORK', value: 'Wi-Fi 6 + BT 5.1', icon: <FaWifi />, tag: '802.11AX' },
      { label: 'BATTERY', value: '56Wh 4-Cell', icon: <FaBatteryFull />, tag: 'LI-ION' },
      { label: 'WEIGHT', value: '~2.3 kg', icon: <FaWeightHanging />, tag: 'LAPTOP' },
    ],
    specLayout: 'flat',
    imagePosition: 'right',
    specTitle: 'HARDWARE SPECIFICATIONS',
  ...
  },
  {
    ...
    gallery: [
      '/images/gear/aula-f75-view-1.png',
    ],
    ...
    specs: [
      ...
      { label: 'SWITCHES', value: 'Leobog/Outemu', icon: <FaBolt />, tag: 'HOT-SWAP' },
      { label: 'RGB', value: '16.8M Colors', icon: <FaPalette />, tag: 'PER-KEY' },
      { label: 'WIRELESS', value: '2.4GHz', icon: <FaWifi />, tag: 'TRI-MODE' },
      { label: 'BATTERY', value: '3000mAh / 200 Hrs', icon: <FaClock />, tag: 'LONG-LIFE' },
      { label: 'CONNECT', value: 'USB-C / BT 5.0', icon: <FaUsb />, tag: 'TRI-MODE' },
      { label: 'KEYCAPS', value: 'PBT Double-Shot', icon: <FaKeyboard />, tag: 'DURABLE' },
      { label: 'MOUNT', value: 'Silicone Gasket', icon: <FaAdjust />, tag: 'BOUNCE' },
    ],
    specLayout: 'split',
    imagePosition: 'left',
  ...
  },
  {
    ...
    gallery: [
      '/images/gear/aula-s2022-view-1.png',
      '/images/gear/aula-s2022-view-2.png',
      '/images/gear/aula-s2022-view-3.png',
      '/images/gear/aula-s2022-view-4.png',
      '/images/gear/aula-s2022-view-5.png',
    ],
    specs: [
  ...
  },
  {
    ...
    gallery: [
      '/images/gear/g-pro-wireless-view-1.png',
      '/images/gear/g-pro-wireless-view-2.png',
      '/images/gear/g-pro-wireless-view-3.png',
    ],
    specs: [
  ...
  },
  {
    ...
    gallery: [
      '/images/gear/aula-sc660-view-1.png',
      '/images/gear/aula-sc660-view-2.png',
      '/images/gear/aula-sc660-view-3.png',
      '/images/gear/aula-sc660-view-4.png',
      '/images/gear/aula-sc660-view-5.png',
    ],
    specs: [
      { label: 'SENSOR', value: 'PAW3395 / 26,000 DPI', icon: <FaMicrochip />, tag: 'FLAGSHIP' },
      { label: 'POLLING', value: '1000Hz (1ms)', icon: <FaBolt />, tag: 'ZERO LATENCY' },
      { label: 'WEIGHT', value: '59 Grams', icon: <FaWeightHanging />, tag: 'ULTRA-LIGHT' },
      { label: 'WIRELESS', value: '2.4GHz + BT + USB', icon: <FaWifi />, tag: 'TRI-MODE' },
      { label: 'BATTERY', value: '500mAh / 150 Hrs', icon: <FaClock />, tag: 'LONG-LIFE' },
      { label: 'SWITCHES', value: 'Huano 60M', icon: <FaBolt />, tag: 'DURABLE' },
  ...
  },
  {
    ...
    gallery: [
      '/images/gear/glorious-model-o-view-1.png',
      '/images/gear/glorious-model-o-view-2.png',
      '/images/gear/glorious-model-o-view-3.png',
      '/images/gear/glorious-model-o-view-4.png',
      '/images/gear/glorious-model-o-view-5.png',
    ],
    specs: [
  ...
  slug: 'kz-edx-ultra',
    name: 'KZ EDX ULTRA',
    subtitle: 'AUDIO_CLASS: IN-EAR_MONITOR // HI-FI_LAB',
    category: 'audio',
    status: 'active',
    image: '/images/gear/kz-edx.png',
    gallery: [
      '/images/gear/kz-edx-view-1.png',
    ],
    specs: [
  ...
  },
  {
    ...
    gallery: [
      '/images/gear/apc-easy-ups-view-2.png',
    ],
  ...
  slug: 'kz-castor-pro',
    name: 'KZ CASTOR PRO',
    subtitle: 'AUDIO_CLASS: IN-EAR_MONITOR // SILVER_ALLOY',
    category: 'audio',
    status: 'active',
    image: '/images/gear/kz-castor-pro.png',
    gallery: [
      '/images/gear/kz-castor-pro-view-1.png',
    ],
    specs: [
  ...
  },
  {
    ...
    gallery: [
      '/images/gear/targ-27-view-1.png',
    ],
  ...
  },
  {
    ...
    gallery: [
      '/images/gear/apc-back-ups-1400va-view-1.png',
    ],
    tags: ['READY'],
    specs: [
