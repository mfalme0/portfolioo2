...
export const gearItems: GearItem[] = [
{
  ...
  specs: [
    { label: 'CPU', value: 'Intel i9-14900HX', icon: <SiIntel /> },
    { label: 'GPU', value: 'RTX 4060 (140W)', icon: <SiNvidia /> },
    { label: 'RAM', value: '32GB DDR5-5600', icon: <FaMemory /> },
    { label: 'STORAGE', value: '3TB NVMe SSD', icon: <FaHdd /> },
    { label: 'DISPLAY', value: '18" QHD+ 240Hz', icon: <MdOutlineMonitor /> },
    { label: 'NETWORK', value: 'Wi-Fi 6E / 2.5G', icon: <FaWifi /> },
    { label: 'COOLING', value: 'Tri-Fan', icon: <FaThermometerHalf /> },
  ],
  specLayout: 'flat',
  imagePosition: 'left',
  ...
  connectivity: [
    { label: 'THUNDERBOLT 4', value: '1x USB4 40Gbps', icon: <FaBolt />, tag: 'PD+DP' },
    { label: 'USB-A', value: '2x USB 3.2 Gen 2 10Gbps', icon: <FaUsb />, tag: 'TYPE-A' },
    { label: 'USB-C', value: '1x USB 3.2 Gen 2 10Gbps', icon: <FaUsb />, tag: 'TYPE-C' },
    { label: 'HDMI', value: '1x HDMI 2.1 48Gbps', icon: <FaTv />, tag: '4K/120Hz' },
    { label: 'AUDIO', value: '1x 3.5mm Combo', icon: <FaPlug />, tag: 'TRRS' },
    { label: 'ETHERNET', value: '1x RJ45 2.5Gbps', icon: <FaWifi />, tag: '2.5GBASE-T' },
  ],
},
  {
    slug: 'rog-strix-g15',
    ...
    specs: [
      { label: 'CPU', value: 'Ryzen 7 4800H', icon: <SiAmd /> },
      { label: 'GPU', value: 'RTX 3050', icon: <BsNvidia /> },
      { label: 'RAM', value: '32GB DDR4', icon: <FaMemory /> },
      { label: 'STORAGE', value: '1TB NVMe', icon: <FaHdd /> },
      { label: 'DISPLAY', value: '15.6" 144Hz', icon: <FaDesktop /> },
      { label: 'COOLING', value: 'Dual-Fan', icon: <FaThermometerHalf /> },
    ],
    specLayout: 'flat',
    imagePosition: 'right',
    specTitle: 'HARDWARE SPECIFICATIONS',
    ...
    connectivity: [
      { label: 'USB-C', value: '1x USB 3.2 Gen 1 5Gbps', icon: <FaUsb />, tag: 'TYPE-C' },
      { label: 'USB-A', value: '3x USB 3.2 Gen 1 5Gbps', icon: <FaUsb />, tag: 'TYPE-A' },
      { label: 'HDMI', value: '1x HDMI 2.0b 18Gbps', icon: <FaTv />, tag: '4K/60Hz' },
      { label: 'ETHERNET', value: '1x RJ45 1Gbps', icon: <FaWifi />, tag: 'Gigabit' },
      { label: 'AUDIO', value: '1x 3.5mm Combo', icon: <FaPlug />, tag: 'TRRS' },
    ],
  },
  {
    ...
    specs: [
      { label: 'LAYOUT', value: '75%', icon: <FaKeyboard />, tag: 'COMPACT' },
      { label: 'POLLING', value: '1000Hz', icon: <MdSpeed />, tag: 'ULTRA-FAST' },
      { label: 'RGB', value: '16.8M Colors', icon: <FaPalette />, tag: 'PER-KEY' },
      { label: 'WIRELESS', value: '2.4GHz', icon: <FaWifi />, tag: 'TRI-MODE' },
      { label: 'BATTERY', value: '200 Hours', icon: <FaClock />, tag: 'LONG-LIFE' },
      { label: 'CONNECT', value: 'USB-C', icon: <FaUsb />, tag: 'HOT-SWAP' },
    ],
    specLayout: 'split',
    imagePosition: 'left',
    ...
    price: 'KES 6,500',
    connectivity: [
      { label: 'USB', value: 'USB-C (Wired)', icon: <FaPlug />, tag: '1Gbps' },
      { label: 'RF', value: '2.4GHz Wireless', icon: <FaWifi />, tag: '1000Hz' },
      { label: 'BLUETOOTH', value: 'BT 5.x', icon: <FaWifi />, tag: 'TRI-MODE' },
    ],
  },
  {
    slug: 'aula-s2022',
    ...
    specs: [
      { label: 'LAYOUT', value: '104 Key', icon: <FaKeyboard />, tag: 'FULL SIZE' },
      { label: 'POLLING', value: '1000Hz', icon: <MdSpeed />, tag: 'STABLE' },
      { label: 'SWITCHES', value: 'Blue', icon: <FaBolt />, tag: 'CLICKY' },
      { label: 'RGB', value: 'Multi-Color', icon: <FaPalette />, tag: 'EFFECTS' },
      { label: 'BUILD', value: 'Classic', icon: <FaKeyboard />, tag: 'RELIABLE' },
      { label: 'CONNECT', value: 'USB Wired', icon: <FaPlug />, tag: 'PLUG-PLAY' },
    ],
    specLayout: 'split',
    imagePosition: 'left',
    specTitle: 'KEYBOARD SPECIFICATIONS',
    ...
    price: 'KES 3,000',
    connectivity: [
      { label: 'USB', value: 'USB-A (Wired)', icon: <FaPlug />, tag: 'FULL-SPEED' },
    ],
  },
  {
    slug: 'g-pro-wireless',
    ...
    specs: [
      { label: 'SENSOR', value: 'HERO 25K', icon: <FaMicrochip />, tag: 'ZERO SMOOTHING' },
      { label: 'WIRELESS', value: 'LIGHTSPEED', icon: <FaWifi />, tag: '1MS LATENCY' },
      { label: 'WEIGHT', value: '80 Grams', icon: <FaWeightHanging />, tag: 'ULTRA-LIGHT' },
      { label: 'BATTERY', value: '48-60 Hrs', icon: <FaBatteryFull />, tag: 'LONG-LIFE' },
      { label: 'CHARGING', value: 'PowerPlay', icon: <FaBolt />, tag: 'WIRELESS' },
      { label: 'SWITCHES', value: '50M Clicks', icon: <SiLogitech />, tag: 'MECHANICAL' },
    ],
    specLayout: 'split',
    imagePosition: 'right',
    ...
    price: 'KES 12,000',
    connectivity: [
      { label: 'CHARGING', value: 'Micro-USB', icon: <FaUsb />, tag: 'DATA+CHARGE' },
      { label: 'WIRELESS', value: '2.4GHz LIGHTSPEED', icon: <FaWifi />, tag: '1MS LATENCY' },
    ],
  },
  {
    slug: 'aula-sc660',
    ...
    specs: [
      { label: 'DPI', value: '26,000', icon: <MdSpeed />, tag: 'ULTRA-PRECISE' },
      { label: 'POLLING', value: '1000Hz', icon: <FaBolt />, tag: 'ZERO LATENCY' },
      { label: 'WEIGHT', value: '59 Grams', icon: <FaWeightHanging />, tag: 'ULTRA-LIGHT' },
      { label: 'WIRELESS', value: 'Tri-Mode', icon: <FaWifi />, tag: '2.4GHZ/BT' },
      { label: 'BATTERY', value: '150 Hours', icon: <FaClock />, tag: 'LONG-LIFE' },
      { label: 'RGB', value: 'Multi-Color', icon: <FaPalette />, tag: 'CUSTOM' },
    ],
    specLayout: 'split',
    imagePosition: 'left',
    specTitle: 'MOUSE SPECIFICATIONS',
    ...
    price: 'KES 4,500',
    connectivity: [
      { label: 'CHARGING', value: 'USB-C', icon: <FaUsb />, tag: 'DATA+CHARGE' },
      { label: 'WIRELESS', value: '2.4GHz / BT', icon: <FaWifi />, tag: 'TRI-MODE' },
    ],
  },
  {
    ...
    price: 'KES 6,000',
    connectivity: [
      { label: 'CABLE', value: 'USB-A Ascended Cord', icon: <FaPlug />, tag: 'FLEXIBLE' },
    ],
  },
  {
    slug: 'kz-edx-ultra',
    ...
    specs: [
      { label: 'DRIVER', value: '10mm Dynamic', icon: <GiSoundWaves />, tag: 'FULL-RANGE' },
      { label: 'FREQ RESPONSE', value: '20Hz-40kHz', icon: <FaMusic />, tag: 'EXTENDED' },
      { label: 'IMPEDANCE', value: '23 Ohms', icon: <FaBolt />, tag: 'EASY DRIVE' },
      { label: 'OUTPUT', value: '108dB', icon: <FaVolumeUp />, tag: 'SENSITIVITY' },
      { label: 'CABLE', value: 'Detachable', icon: <FaPlug />, tag: '0.75MM' },
      { label: 'MIC', value: 'In-Line', icon: <FaMicrophone />, tag: 'BUILT-IN' },
    ],
    specLayout: 'split',
    imagePosition: 'left',
    ...
    price: 'KES 2,500',
    connectivity: [
      { label: 'CABLE', value: 'Detachable 0.75mm 2-Pin', icon: <FaPlug />, tag: 'OFC' },
      { label: 'JACK', value: '3.5mm TRS', icon: <FaMusic />, tag: 'GOLD-PLATED' },
    ],
  },
  {
    ...
    specs: [
      { label: 'CAPACITY', value: '650 VA', icon: <GiElectric />, tag: 'POWER RATING' },
      { label: 'OUTPUT', value: '360 Watts', icon: <FaBolt />, tag: 'MAX LOAD' },
      { label: 'VOLTAGE', value: '230V', icon: <FaPlug />, tag: 'UNIVERSAL' },
      { label: 'AVR', value: 'Automatic', icon: <FaAdjust />, tag: 'REGULATED' },
      { label: 'OUTLETS', value: '1 Universal', icon: <MdOutlet />, tag: 'SURGE+BAT' },
      { label: 'PROTECTION', value: 'Surge + AVR', icon: <FaShieldAlt />, tag: 'COMPACT' },
    ],
    specLayout: 'split',
    imagePosition: 'left',
    ...
    price: 'KES 8,500',
    connectivity: [
      { label: 'OUTLET', value: '1x Universal 230V', icon: <MdOutlet />, tag: 'SURGE+BAT' },
      { label: 'PROTECTION', value: 'Phone/Modem', icon: <FaPlug />, tag: 'RJ11' },
    ],
  },
  {
    slug: 'kz-castor-pro',
    ...
    specs: [
      { label: 'DRIVERS', value: '10mm x2 Dynamic', icon: <GiSoundWaves />, tag: 'DUAL' },
      { label: 'FREQ RESPONSE', value: '20Hz-40kHz', icon: <FaVolumeUp />, tag: 'WIDE' },
      { label: 'IMPEDANCE', value: '22-40 Ohms', icon: <FaBolt />, tag: 'HARMAN TARGET' },
      { label: 'CHASSIS', value: 'Zinc Alloy Silver', icon: <HiOutlineSparkles />, tag: 'PREMIUM' },
      { label: 'TUNING', value: '4-Level Switch', icon: <FaAdjust />, tag: 'CUSTOM' },
      { label: 'CABLE', value: '0.75mm 2-Pin', icon: <FaPlug />, tag: 'OFC FLAT' },
    ],
    specLayout: 'split',
    imagePosition: 'left',
    specTitle: 'IEM SPECIFICATIONS',
    ...
    price: 'KES 4,000',
    connectivity: [
      { label: 'CABLE', value: 'Detachable 0.75mm 2-Pin', icon: <FaPlug />, tag: 'OFC FLAT' },
      { label: 'JACK', value: '3.5mm TRS', icon: <FaMusic />, tag: 'GOLD-PLATED' },
    ],
  },
  {
    ...
    specs: [
      { label: 'DRIVERS', value: '50mm Pro-G', icon: <FaVolumeUp />, tag: 'AUDIO' },
      { label: 'SURROUND', value: 'DTS:X 2.0', icon: <GiSoundWaves />, tag: 'IMMERSIVE' },
      { label: 'WIRELESS', value: 'LIGHTSPEED', icon: <FaWifi />, tag: '2.4GHZ' },
      { label: 'BATTERY', value: '12 Hours', icon: <FaBatteryFull />, tag: 'RGB ON' },
      { label: 'MIC', value: '6mm Flip-Mute', icon: <FaMicrophone />, tag: 'BUILT-IN' },
      { label: 'RGB', value: 'LIGHTSYNC', icon: <SiLogitech />, tag: 'CUSTOM' },
    ],
    specLayout: 'split',
    imagePosition: 'right',
    ...
    connectivity: [
      { label: 'CHARGING', value: 'Micro-USB', icon: <FaUsb />, tag: 'DATA+CHARGE' },
      { label: 'WIRELESS', value: '2.4GHz LIGHTSPEED', icon: <FaWifi />, tag: '1MS LATENCY' },
      { label: 'WIRED', value: '3.5mm Analog', icon: <FaPlug />, tag: 'AUX MODE' },
    ],
  },
  {
    ...
    specs: [
      { label: 'RESOLUTION', value: '1440p QHD', icon: <MdHighQuality />, tag: '2560x1440' },
      { label: 'REFRESH', value: '180Hz', icon: <IoMdSpeedometer />, tag: 'HIGH-FPS' },
      { label: 'PANEL', value: 'IPS 27"', icon: <FaTv />, tag: 'FAST RESPONSE' },
      { label: 'RESPONSE', value: '1ms (GtG)', icon: <FaClock />, tag: 'ULTRA-FAST' },
      { label: 'COLOR', value: '99% sRGB', icon: <FaPalette />, tag: 'ACCURATE' },
      { label: 'ADAPTIVE', value: 'FreeSync', icon: <FaAdjust />, tag: 'TEAR-FREE' },
    ],
    specLayout: 'split',
    imagePosition: 'right',
    ...
    price: 'KES 30,000',
    connectivity: [
      { label: 'HDMI', value: '2x HDMI 2.0 18Gbps', icon: <FaTv />, tag: 'QHD/165Hz' },
      { label: 'DP', value: '2x DisplayPort ', icon: <MdOutlineMonitor />, tag: 'QHD/180Hz' },
      { label: 'AUDIO', value: '3.5mm Out', icon: <FaPlug />, tag: 'HEADPHONE' },
    ],
  },
  {
    slug: 'benq-xl2720z',
    ...
    specs: [
      { label: 'RESOLUTION', value: '1080p FHD', icon: <MdHighQuality />, tag: '1920x1080' },
      { label: 'REFRESH', value: '144Hz', icon: <IoMdSpeedometer />, tag: 'HIGH-FPS' },
      { label: 'PANEL', value: 'TN 27"', icon: <FaTv />, tag: '1ms GTG' },
      { label: 'RESPONSE', value: '1ms (GtG)', icon: <FaClock />, tag: 'ULTRA-FAST' },
      { label: 'BRIGHTNESS', value: '300 cd/m²', icon: <HiOutlineSparkles />, tag: 'VIVID' },
      { label: 'FEATURES', value: 'Flicker-Free', icon: <FaShieldAlt />, tag: 'EYE-CARE' },
    ],
    specLayout: 'split',
    imagePosition: 'right',
    specTitle: 'DISPLAY SPECIFICATIONS',
    ...
    price: 'KES 25,000',
    connectivity: [
      { label: 'HDMI', value: '2x HDMI 1.4', icon: <FaTv />, tag: '1080p/144Hz' },
      { label: 'DP', value: '1x DisplayPort 1.2', icon: <MdOutlineMonitor />, tag: '1080p/144Hz' },
      { label: 'DVI', value: '1x DVI-D Dual Link', icon: <FaPlug />, tag: '1080p/144Hz' },
      { label: 'VGA', value: '1x D-Sub', icon: <FaDesktop />, tag: 'ANALOG' },
      { label: 'USB', value: '3x USB 2.0 + 1 Upstream', icon: <FaUsb />, tag: 'HUB' },
    ],
  },
  {
    ...
    tags: ['READY'],
    specs: [
      { label: 'CAPACITY', value: '1400 VA', icon: <GiElectric />, tag: 'POWER RATING' },
      { label: 'OUTPUT', value: '810 Watts', icon: <FaBolt />, tag: 'MAX LOAD' },
      { label: 'OUTLETS', value: '10 Total', icon: <MdOutlet />, tag: '5+5 SURGE/BAT' },
      { label: 'RUNTIME', value: '12 Min', icon: <FaClock />, tag: '@400W LOAD' },
      { label: 'BATTERY', value: 'SLA Pack', icon: <FaBatteryFull />, tag: 'REPLACEABLE' },
      { label: 'PROTECTION', value: 'Surge+Lightning', icon: <FaShieldAlt />, tag: 'SHIELDED' },
    ],
    specLayout: 'split',
    imagePosition: 'right',
    specTitle: 'POWER SPECIFICATIONS',
    ...
    price: 'KES 25,000',
    connectivity: [
      { label: 'OUTLETS', value: '10x NEMA 5-15R', icon: <MdOutlet />, tag: '5+5 SURGE/BAT' },
      { label: 'USB', value: 'USB HID Port', icon: <FaUsb />, tag: 'MONITORING' },
      { label: 'RJ45', value: 'In + Out', icon: <FaWifi />, tag: 'SURGE' },
      { label: 'COAX', value: 'In + Out', icon: <FaPlug />, tag: 'SURGE' },
    ],
  },
  {
    slug: 'dualshock-4',
    ...
    specs: [
      { label: 'CONNECTIVITY', value: 'Bluetooth 2.1+EDR', icon: <FaBluetooth />, tag: 'WIRELESS' },
      { label: 'BATTERY', value: '8 Hours', icon: <FaBatteryFull />, tag: 'LITHIUM-ION' },
      { label: 'SENSORS', value: '6-Axis Gyro+Accel', icon: <FaSyncAlt />, tag: 'MOTION' },
      { label: 'TOUCHPAD', value: '2-Point Capacitive', icon: <FaCrosshairs />, tag: 'CLICKABLE' },
      { label: 'AUDIO', value: '3.5mm + Stereo', icon: <FaHeadphones />, tag: 'BUILT-IN' },
      { label: 'LIGHT BAR', value: 'RGB Multi-Color', icon: <FaPalette />, tag: 'CAMERA-TRACKED' },
    ],
    specLayout: 'split',
    imagePosition: 'left',
    ...
    price: 'KES 6,500',
    connectivity: [
      { label: 'WIRELESS', value: 'Bluetooth 2.1+EDR', icon: <FaBluetooth />, tag: 'STANDARD' },
      { label: 'WIRED', value: 'Micro-USB', icon: <FaUsb />, tag: 'DATA+CHARGE' },
      { label: 'AUDIO', value: '3.5mm TRRS', icon: <FaPlug />, tag: 'HEADSET' },
    ],
  },
  {
    slug: 'xbox-one-white',
    ...
    specs: [
      { label: 'CONNECTIVITY', value: 'Xbox Wireless + BT', icon: <FaWifi />, tag: 'DUAL-MODE' },
      { label: 'BATTERY', value: '30+ Hours', icon: <FaBatteryFull />, tag: 'AA (2x)' },
      { label: 'TRIGGERS', value: 'Impulse Vibration', icon: <FaBolt />, tag: 'HAPTIC' },
      { label: 'D-PAD', value: 'Hybrid Faceted', icon: <FaGamepad />, tag: 'PRECISE' },
      { label: 'AUDIO', value: '3.5mm Stereo', icon: <FaHeadphones />, tag: 'BUILT-IN' },
      { label: 'COMPAT', value: 'Xbox One / PC', icon: <FaUsb />, tag: 'DUAL-PLATFORM' },
    ],
    specLayout: 'split',
    imagePosition: 'right',
    specTitle: 'CONTROLLER SPECIFICATIONS',
    ...
    price: 'KES 5,500',
    connectivity: [
      { label: 'WIRELESS', value: 'Xbox Wireless + BT 4.0', icon: <FaWifi />, tag: 'DUAL-MODE' },
      { label: 'WIRED', value: 'Micro-USB', icon: <FaUsb />, tag: 'DATA+CHARGE' },
      { label: 'AUDIO', value: '3.5mm TRRS', icon: <FaPlug />, tag: 'HEADSET' },
    ],
  },
  {
    ...
    specs: [
      ...
      { label: 'TRIGGERS', value: 'Impulse Vibration', icon: <FaBolt />, tag: 'HAPTIC' },
      { label: 'D-PAD', value: 'Hybrid Faceted', icon: <FaGamepad />, tag: 'PRECISE' },
      { label: 'DESIGN', value: 'Recon Tech Camo', icon: <FaCrosshairs />, tag: 'EXCLUSIVE' },
      { label: 'COMPAT', value: 'Xbox One / PC', icon: <FaUsb />, tag: 'DUAL-PLATFORM' },
    ],
    specLayout: 'split',
    imagePosition: 'left',
