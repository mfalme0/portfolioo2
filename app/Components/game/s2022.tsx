...
import { FaKeyboard, FaBolt, FaPalette, FaSkullCrossbones, FaArchive, FaPlug } from 'react-icons/fa';
import { MdSpeed } from 'react-icons/md';
import { RiAlertFill } from 'react-icons/ri';

// ---------------------------------------------
// 1. SEGMENT GAUGE (Modified for retired look)
// ---------------------------------------------
...
// ---------------------------------------------
// 2. TECH CARD (Modified for retired look)
// ---------------------------------------------
  ...
  return (
    <section className="relative w-full py-20 bg-black text-white font-sans">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 50px, #ff6600 50px, #ff6600 60px)'
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 border-l-4 border-gray-600 pl-6 relative">
          <div className="absolute -left-3 top-0 bg-orange-600 text-white text-xs font-bold px-2 py-1 rotate-[-5deg] shadow-lg">
            RETIRED
          </div>
          ...
          <p className="font-mono text-gray-500 text-sm md:text-base">
            KEYBOARD_CLASS: MECHANICAL // <span className="text-orange-500">STATUS: OUT_OF_SERVICE</span>
          </p>
          ...
          <motion.div 
            ...
            className="mt-4 flex items-center gap-3 bg-orange-950/30 border border-orange-900/50 p-3 rounded"
          >
            <RiAlertFill className="text-orange-500 text-2xl flex-shrink-0" />
            <div>
              <p className="text-orange-400 text-sm font-bold uppercase">Unit Retired</p>
              <p className="text-gray-400 text-xs">This keyboard has been retired and replaced by AULA F75 Gasket Mount</p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center">
            <div className="relative w-full border-2 border-gray-800 bg-[#050505] p-8">
              ...
              <div className="absolute bottom-4 left-4 text-[10px] font-mono text-gray-600">
                MODEL: S2022-MECH // ARCHIVED: 2024
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            <div className="mb-10">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-8 border-l border-gray-700 pl-4">
                The <strong className="text-gray-400">AULA S2022</strong> provided reliable mechanical performance with 
                <strong className="text-gray-400"> Blue switches</strong> and RGB backlighting. 
                After faithful service, this unit has been retired from active duty. 
                <span className="text-orange-500"> Successor: AULA F75</span>
              </p>
              ...
              <div className="space-y-6 bg-[#0a0a0a] p-6 border border-gray-800">
                ...
                />
                <SegmentedGauge
                  label="KEY RESPONSE :: ARCHIVED SPEC"
                  maxValue={50}
                  unit="M"
