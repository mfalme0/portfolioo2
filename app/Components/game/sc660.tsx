...
import { FaMouse, FaBolt, FaWifi, FaPalette, FaClock, FaWeightHanging } from 'react-icons/fa';
    ...
    <section className="relative w-full py-20 bg-black text-white font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 border-l-4 border-red-600 pl-6">
          <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter">AULA SC660</h1>
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            <div className="mb-10">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-8 border-l border-gray-700 pl-4">
                The <strong className="text-white">AULA SC660</strong> features an ultra-lightweight design paired with 
                a high-precision <strong className="text-white">26000 DPI sensor</strong>. Tri-mode connectivity and 
                extended battery life make it the ultimate tool for competitive gaming and productivity.
              </p>
